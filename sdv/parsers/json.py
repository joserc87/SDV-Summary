...
json_layout_map = {"regular": 0, "fishing": 1, "foraging": 2, "mining": 3, "combat": 4}
...
def parse_json(data):
    ...
    for tile in tiles:
        ...
        if obj == "weeds":
            ...
            objects.append(
                sprite(
                    "Building", x, y, 5, 3, None, obj.replace("-", " "), None, None, 0
                )
            )
            ...
            objects.append(sprite(name, x, y, 1, 1, 0, T, 5, random.randint(0, 1), 0))
            ...
            if "gravel" in obj:
                ...
                T = 9
            objects.append(sprite("Flooring", x, y, 1, 1, None, T, 0, False, None))
            ...
            print(
                "json input: obj not in known types: {} coords {}, {}".format(obj, x, y)
            )
    ...
    if g:
        greenhouse = sprite("Greenhouse", 25, 12, 0, 6, 1, None, None, None, None)
