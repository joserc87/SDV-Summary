...
def email_confirmation(address,user_id,key):
	...
	body = 'Hello!Someone using this email address just signed up for an account on upload.farm. To verify this is correct, please visit: http://upload.farm/verify_email?i='+str(user_id)+'&t='+str(key)+' If this is in error no action is necessary and you will not hear from us again. Verifying your email address allows us to send you password reset email. Thanks! The upload.farm devs'
	html = '<p>Hello! </p><p>Someone using this email address just signed up for an account on upload.farm. To verify this is correct, please <a href="http://upload.farm/verify_email?i='+str(user_id)+'&t='+str(key)+'">click here</a>.</p> <p>If this is in error no action is necessary and you will not hear from us again. Verifying your email address allows us to send you password reset email.</p><p>Thanks!<br>The upload.farm devs</p>'
	send_email(address,title,body,html)

def old_email_confirmation(address,user_id,key):
	title = 'Confirm upload.farm registration'
	body = 'Hello! Some time ago, someone using this email address signed up for an account on upload.farm. To verify this is correct, please visit: http://upload.farm/verify_email?i='+str(user_id)+'&t='+str(key)+' If this is in error no action is necessary and you will not hear from us again. Verifying your email address allows us to send you password reset email. Thanks! The upload.farm devs'
	html = '<p>Hello!</p><p>Some time ago, someone using this email address signed up for an account on upload.farm. To verify this is correct, please <a href="http://upload.farm/verify_email?i='+str(user_id)+'&t='+str(key)+'">click here</a>.</p> <p>If this is in error no action is necessary and you will not hear from us again. Verifying your email address allows us to send you password reset email.</p><p>Thanks!<br>The upload.farm devs</p>'
	send_email(address,title,body,html)

def email_passwordreset(address,user_id,key):
	title = 'Reset upload.farm password'
	body = 'Hello! Someone has requested a password reset for this email address on upload.farm. To reset your password, please visit: http://upload.farm/reset?i='+str(user_id)+'&t='+str(key)+' If this is in error no action is necessary.'
	html = '<p>Hello!</p><p>Someone has requested a password reset for this email address on upload.farm. To reset your password, please <a href="http://upload.farm/reset?i='+str(user_id)+'&t='+str(key)+'">click here</a>.</p> <p>If this is in error no action is necessary.</p>'
	send_email(address,title,body,html)
