...
def loadAssets():
    assets = {
                'base': {
                            'spring': Image.open(op.join(app.config['ASSET_FOLDER'], 'bases', 'spring_base.png')),
                            'summer': Image.open(op.join(app.config['ASSET_FOLDER'], 'bases', 'summer_base.png')),
                            'fall': Image.open(op.join(app.config['ASSET_FOLDER'], 'bases', 'fall_base.png')),
                            'winter': Image.open(op.join(app.config['ASSET_FOLDER'], 'bases', 'winter_base.png'))
                          },
                'overlays': {
                                'spring': [
                                                Image.open(op.join(app.config['ASSET_FOLDER'], 'bases', 'spring_overlay_0.png')),
                                                Image.open(op.join(app.config['ASSET_FOLDER'], 'bases', 'spring_overlay_1.png')),
                                                Image.open(op.join(app.config['ASSET_FOLDER'], 'bases', 'spring_overlay_2.png')),
                                                Image.open(op.join(app.config['ASSET_FOLDER'], 'bases', 'spring_overlay_3.png'))
                                            ],
                                'summer': [
                                                Image.open(op.join(app.config['ASSET_FOLDER'], 'bases', 'summer_overlay_0.png')),
                                                Image.open(op.join(app.config['ASSET_FOLDER'], 'bases', 'summer_overlay_1.png')),
                                                Image.open(op.join(app.config['ASSET_FOLDER'], 'bases', 'summer_overlay_2.png')),
                                                Image.open(op.join(app.config['ASSET_FOLDER'], 'bases', 'summer_overlay_3.png'))
                                            ],
                                'fall': [
                                                Image.open(op.join(app.config['ASSET_FOLDER'], 'bases', 'fall_overlay_0.png')),
                                                Image.open(op.join(app.config['ASSET_FOLDER'], 'bases', 'fall_overlay_1.png')),
                                                Image.open(op.join(app.config['ASSET_FOLDER'], 'bases', 'fall_overlay_2.png')),
                                                Image.open(op.join(app.config['ASSET_FOLDER'], 'bases', 'fall_overlay_3.png'))
                                            ],
                                'winter': [
                                                Image.open(op.join(app.config['ASSET_FOLDER'], 'bases', 'winter_overlay_0.png')),
                                                Image.open(op.join(app.config['ASSET_FOLDER'], 'bases', 'winter_overlay_1.png')),
                                                Image.open(op.join(app.config['ASSET_FOLDER'], 'bases', 'winter_overlay_2.png')),
                                                Image.open(op.join(app.config['ASSET_FOLDER'], 'bases', 'winter_overlay_3.png'))
                                            ]
                               },
                'objects': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'objects.png')),
                'craftables': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'craftables.png')),
                'flooring': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'flooring.png')),
                'hoe dirt': {
                              'normal': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'hoeDirt.png')),
                              'winter': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'hoeDirtsnow.png'))
                              },
                'crops': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'crops.png')),
                'fences': {
                                'wood': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'Fence1.png')),
                                'stone': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'Fence2.png')),
                                'iron': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'Fence3.png')),
                                'hardwood': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'Fence5.png'))
                            },
                'trees': {
                            'oak': {
                                        'spring': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'trees', 'tree1_spring.png')),
                                        'summer': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'trees', 'tree1_summer.png')),
                                        'fall': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'trees', 'tree1_fall.png')),
                                        'winter': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'trees', 'tree1_winter.png'))
                                    },
                            'maple': {
                                        'spring': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'trees', 'tree2_spring.png')),
                                        'summer': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'trees', 'tree2_summer.png')),
                                        'fall': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'trees', 'tree2_fall.png')),
                                        'winter': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'trees', 'tree2_winter.png'))
                                        },
                            'pine': {
                                        'spring': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'trees', 'tree3_spring.png')),
                                        'summer': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'trees', 'tree3_summer.png')),
                                        'fall': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'trees', 'tree3_fall.png')),
                                        'winter': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'trees', 'tree3_winter.png'))
                                     },
                            'mushroom': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'trees', 'mushroom_tree.png')),
                            'fruit': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'fruitTrees.png'))
                            },
                'grass': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'grass', 'grass.png')),
                'buildings': {
                                    'barn': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'buildings', 'Barn.png')),
                                    'big barn': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'buildings', 'Big Barn.png')),
                                    'deluxe barn': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'buildings', 'Deluxe Barn.png')),
                                    'coop': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'buildings', 'Coop.png')),
                                    'big coop': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'buildings', 'Big Coop.png')),
                                    'deluxe coop': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'buildings', 'Deluxe Coop.png')),
                                    'greenhouse': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'buildings', 'Greenhouse.png')),
                                    'house': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'buildings', 'houses.png')),
                                    'silo': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'buildings', 'Silo.png')),
                                    'slime hutch': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'buildings', 'Slime Hutch.png')),
                                    'stable': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'buildings', 'Stable.png')),
                                    'well': Image.open(op.join(app.config['ASSET_FOLDER'], 'farm', 'buildings', 'Well.png')),
                                }
              }
    return assets
...
def generateMinimap(farm):
    image = Image.open(op.join(app.config['ASSET_FOLDER'], 'bases', 'minimap_base.png'))
    pixels = image.load()
