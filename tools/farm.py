...
def copy_farm():
    ...
    tileSheets = ["Craftables.png", "crops.png", "fruitTrees.png"]

    maps = ["springobjects.png"]

    looseSprites = ["Fence1.png", "Fence2.png", "Fence3.png", "Fence5.png"]

    copy_images(buildings, "Buildings", os.path.join("farm", "buildings"))
    copy_images(
        terrainFeatures, "TerrainFeatures", os.path.join("farm", "terrainFeatures")
    )
